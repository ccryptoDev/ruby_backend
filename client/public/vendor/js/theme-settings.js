    ...
    541: function (t, e, s) {
          ...
          function t(e) {
            ...
            if (
              ...
              if (
                ...
                (this.settings.footerBgs = u || t.FOOTER_BGS),
                (this.settings.defaultFooterBg = v || "footer-theme"),
                (this.settings.availableThemes = m || t.AVAILABLE_THEMES),
                (this.settings.defaultTheme = this._getDefaultTheme(
                  void 0 !== f ? f : 1,
                )),
                (this.settings.controls = a || d),
                (this.settings.styles = r || g),
                (this.settings.lang = b || "en"),
                (this.pathResolver =
                  p ||
                  function (t) {
                    return t;
              ...
              },
              {
                ...
                value: function () {
                  var t = this,
                    e =
                      arguments.length > 0 && void 0 !== arguments[0]
                        ...
                        : document;
                  this._cleanup(),
                    (this.container = this._getElementFromString(n.a));
                  ...
                  a.addEventListener("click", o),
                    this._listeners.push([a, "click", o]);
                  ...
                  if (this._hasControls("rtl")) {
                    ...
                    h.addEventListener("change", d),
                      this._listeners.push([h, "change", d]);
                  ...
                  if (
                    ...
                    if (this._hasControls("layoutPosition")) {
                      (this._controls.layoutPosition = f.querySelector(
                        "select",
                      )),
                    ...
                    if (
                      ((this._controls.layoutReversedW = this.container.querySelector(
                        ".theme-settings-layoutReversed",
                      )),
                      this._hasControls("layoutReversed"))
                    ) {
                      (this._controls.layoutReversed = this._controls.layoutReversedW.querySelector(
                        "input",
                      )),
                        this.settings.layoutReversed &&
                          this._controls.layoutReversed.setAttribute(
                  ...
                  this._hasControls("sidenavBg")
                    ? ((this._controls.sidenavBgWInner = x.querySelector(
                      ...
                      this.settings.sidenavBgs.forEach(function (e) {
                        ...
                        var n = function (e) {
                          for (
                            var s = t._controls.sidenavBgWInner.querySelectorAll(
                                ".theme-settings-bg-item",
                              ),
                              i = 0,
                              n = s.length;
      ...
      (u.AVAILABLE_THEMES = [
        ...
        },
        {
          name: "theme-cotton",
          title: "Сotton",
          colors: { primary: "#1E2A46", navbar: "#ffffff", sidenav: "#ffffff" },
          colorsDark: {
            primary: "#1E2A46",
            navbar: "#25282e",
            sidenav: "#d2d3d4",
